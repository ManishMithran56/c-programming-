...
int sum (int count, ...) {
    ...
    // Initialize args to store all arguments after 'count'
    va_start(args, count);
    ...
    // Clean up memory assigned to args
    va_end(args);
    return total;
}

// Variadic function to find the minimum integer
int min (int count, ...) {
    va_list args;
    va_start(args, count);
    
    // Fetch the first element to initialize the minimum tracker
...
// Variadic function to find the maximum integer
int max (int count, ...) {
    va_list args;
    va_start(args, count);
    
    // Fetch the first element to initialize the maximum tracker
